...
```
yarn add -D webpack webpack-cli html-loader file-loader url-loader css-loader sass-loader sass html-webpack-plugin mini-css-extract-plugin dotenv-webpack
```
